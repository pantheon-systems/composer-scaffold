...
use Pantheon\Composer\Plugin\Scaffold\Interpolator;
use Pantheon\Composer\Plugin\Scaffold\ScaffoldFileInfo;
...
class ScaffoldFileCollection implements \IteratorAggregate {
   ...
   *
   * @var \Pantheon\Composer\Plugin\Scaffold\ScaffoldFileInfo[][]
   */
   ...
   *
   * @param \Pantheon\Composer\Plugin\Scaffold\Operations\OperationInterface[][] $file_mappings
   ...
   *
   * @param Pantheon\Composer\Plugin\Scaffold\ScaffoldFileInfo[] $scaffold_files
   ...
   * @param \Pantheon\Composer\Plugin\Scaffold\ScaffoldOptions $scaffold_options
   ...
   *
   * @param \Pantheon\Composer\Plugin\Scaffold\Operations\ScaffoldFileCollection $collection
